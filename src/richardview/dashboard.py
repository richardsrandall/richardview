...
class RichardViewDashboard:
    ...
    def add_widget(self, widget, row, column):
        ...
        :type widget: richardview.generic_widget.GenericWidget or richardview.minimal_widget.MinimalWidget
    ...
    def get_widget_by_nickname(self, nickname):
        ...
        :rtype: richardview.generic_widget.GenericWidget or richardview.minimal_widget.MinimalWidget
        """
